...
const config_1 = __importDefault(require("../config")); // Para verificar el entorno (desarrollo/producción)
 ...
 */
const errorHandler = (err, // El error que se propaga
req, res, next // Aunque no lo usemos, debe estar presente para ser un middleware de error
) => {
