...
const app_1 = __importDefault(require("./app")); // Importamos la aplicación Express configurada desde app.ts
const config_1 = __importDefault(require("./config")); // Importamos las configuraciones, incluyendo el puerto
const PORT = config_1.default.port; // Obtenemos el puerto desde nuestra configuración
